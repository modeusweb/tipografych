...
const SECTIONS: Array<{ title: string; items: string[] }> = [
  {
    ...
    items: [
      "Прямые и английские кавычки — на «ёлочки», вложенные (в том числе “английские”) — на „лапки“; точка после закрывающей кавычки убирается, если цитата уже завершена знаком («…дней…». → «…дней…»).",
      ...
      "Знаки охраны прав: «(c)», «(r)», «(tm)» → ©, ®, ™; дроби «1/2» → ½, «5х5» → «5×5»; стрелки «->», «<-», «<=>» → →, ←, ⇔.",
      ...
      "Валюты: «90руб.» и «5000 рублей» → «90 ₽» и «5000 ₽»; знаки вроде «20$» не разъединяются (отбивка знака валюты — в пресете «Издательская»); «100долл.» → «100 долл.».",
