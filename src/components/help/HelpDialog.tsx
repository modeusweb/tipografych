...
const SECTIONS: Array<{ title: string; items: string[] }> = [
  {
    ...
    items: [
      ...
      "Дефис с пробелами — на длинное тире, диапазоны чисел — на короткое тире, дефис перед числом — на типографский минус −; разорванное дефисное слово («кто - то») склеивается обратно.",
