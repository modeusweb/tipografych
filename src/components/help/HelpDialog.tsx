...
const SECTIONS: Array<{ title: string; items: string[] }> = [
  {
    ...
    items: [
      "Прямые и английские кавычки — на «ёлочки», вложенные (в том числе “английские”) — на „лапки“.",
      "Дефис с пробелами — на длинное тире, диапазоны чисел — на короткое тире, дефис перед числом — на типографский минус −.",
